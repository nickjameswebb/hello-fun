...
```json
{
  ...
  "sourceRepositoryPrefix" : "us.gcr.io/daisy-284300/nwebb/tap-packages/1.0.3/ootb_supply_chain_basic"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [dev.local->us.gcr.io/daisy-2843...(truncated)]
